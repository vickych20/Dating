          ...
          <div className='flex justify-center items-center w-full'>
            <div className='w-[30%]'>
              ...
              <input type="Search" placeholder="Search" />
                        <p>ABOUT BLOG</p>
                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Porro expedita natus impedit ut id placeat, sit qui nostrum saepe deserunt ducimus delectus?</p>
                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Velit omnis a deserunt non quam dolores suscipit nostrum nihil perferendis animi! Dolor repellendus eius, maxime dolorem asperiores, omnis quibusdam pariatur incidunt, possimus architecto ratione explicabo!</p>
            </div>
                    <div >
            ...
            <div>
              ...
              <div>
                <h1 className="text-center font-sans text-[16px] text-[#fff] w-[70%] m-auto">
                  Eum cu tantas legere complectitur, hinc utamur ea eam. Eum
                  patrioque mnesarchum eu, diam erant convenire et vis. Et
                  essent evertitur sea, vis cu ubique referrentur, sed eu dicant
                  expetendis. Eum cu
                </h1>
              </div>
